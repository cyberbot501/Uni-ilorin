...
export default function mission() {
  return (
    <div className='px-2 md:px-7 flex flex-col gap-7 md:gap-0 items-center md:flex md:flex-row md:justify-between pt-10 pb-10'>
        <div className='md:w-[638px] md:h-[233px] w-[300px] h-[200px] bg-white shadow-2xl rounded-[7px] md:flex md:flex-row flex flex-col text-center md:text-left items-center gap-1 px-1'>
