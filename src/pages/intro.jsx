...
export default function intro() {  
  return (
    <div className='w-[100%] h-[100%] min-h-[100vh] flex flex-col justify-center items-center' >
        <div className='w-[196px] h-[169px]'>
            <img src={LOGO} alt=""/>
        </div>
        <div>
            <h1 className='text-[40px] font-normal text-black text-center mt-10'>UNIVERSITY OF ILORIN</h1>
            <p className='text-[30px] font-normal text-black text-center mb-10'>Better By Far</p>
        </div>
